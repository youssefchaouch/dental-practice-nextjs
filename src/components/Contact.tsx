    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="flex items-center space-x-3">
              ...
              <a
                href="https://maps.app.goo.gl/y3anxC9ddDkVYPkJ9"
                target="_blank"
        ...
        <div className="w-full h-80 md:h-full rounded-2xl overflow-hidden shadow-lg">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3238.957598633591!2d10.1531029!3d36.8383401!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12fd33ca22ebe471%3A0x4ffc10136272f775!2sCabinet%20Dentaire%20Dr%20Maha%20Chaouch!5e0!3m2!1sen!2stn!4v1692658730123!5m2!1sen!2stn"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
